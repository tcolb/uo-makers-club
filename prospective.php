...
<div class="container-fluid">
  <div class="customBlock">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item">
        <a target="_blank" href="https://learn.adafruit.com/trinket-temerature-humidity-lcd-dislay/the-lcd-dislay">Temerature and Humidity LCD Dislay</a>
      </li>
      <li class="list-group-item">
      ...
      <li class="list-group-item">
        <a target="_blank" href="https://learn.adafruit.com/ro-trinket-rotary-encoder">Rotary Encoder</a>
      </li>
      <li class="list-group-item">
        <a target="_blank" href="https://learn.adafruit.com/trinket-bluetooth-alarm-system">Bluetooth Alarm System</a>
      </li>
      <li class="list-group-item">
        <a target="_blank" href="https://learn.adafruit.com/trinket-owered-rover">3D Printed Autonomous Rover</a>
      </li>
      <li class="list-group-item">
